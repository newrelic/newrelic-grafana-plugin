...
func CreateNewRelicClientObj(apiKey string, factory NewRelicClientFactory) (*newrelic.NewRelic, error) {
...
var CreateNewRelicClient = func(apiKey string, factory NewRelicClientFactory) (*newrelic.NewRelic, error) {
	return CreateNewRelicClientObj(apiKey, factory)
}
